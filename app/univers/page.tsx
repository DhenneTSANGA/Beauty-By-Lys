    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {values.map((v, i) => (
            ...
            >
              <div
                className="flex flex-col gap-4 rounded-2xl border border-border bg-card p-7 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-foreground/5"
              >
      ...
      <section className="relative overflow-hidden">
        <div className="relative h-[60vh] min-h-[400px] w-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center px-5 text-center">
            <RevealOnScroll className="max-w-3xl" animation="animate-zoom-in" once={false}>
      ...
      <section className="mx-auto max-w-4xl px-5 py-20 text-center md:px-8 md:py-28">
        <RevealOnScroll animation="animate-reveal-up" once={false}>
          ...
          <Link
            href="/reservation"
            className="group mt-10 inline-flex items-center gap-3 rounded-full bg-foreground px-8 py-4 text-xs font-medium uppercase tracking-[0.18em] text-background transition-all hover:bg-accent shimmer-btn"
          >
            Prendre rendez-vous
